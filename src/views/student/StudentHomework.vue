    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                console.log("save", this.$store);
                let status= this.$store.state.status
                // this.entityForm[studentHomeworkId]=status.
                 this.entityForm.studentId=status.userId
                  this.entityForm.studentName0=status.username
